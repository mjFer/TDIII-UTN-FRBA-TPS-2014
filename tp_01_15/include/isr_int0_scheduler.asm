...
;   xchg bx,bx
   ...
   mov rcx,CR0
   and rcx,CR0_TS
   cmp rcx,0		;si TS esta en cero es que se accedio a la NM y se uso SIMD
   je saveSIMD
saveSIMDcont: 
   pop rcx
...
saveSIMD:
  mov rcx,rax
  mov rcx,[rcx + task_struct.MMX]
  fxsave [rcx]

  mov rcx,CR0		;seteo el CR0.TS para que la proxima vez que se use en otra task salte la NM
  or rcx,CR0_TS
  mov CR0,rcx 
