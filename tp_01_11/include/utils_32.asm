...
%define VID_MEM 0xb8000     ;ahora el video esta direccionado a la pagina (0x000b8000)


%define VID_MEM_SEG 0xB000 ;definicion de memoria de video en binario dezplazado (MODO REAL)
%define VID_MEM_OFF 0x8000
...
my_itoa:
  ...
  xor edx,edx
itoa_loop: 
  div word ecx    ;eax = eax/ecx + edx | edx = resto
  add dl, 0x30
  mov byte [esi],dl
  inc esi
