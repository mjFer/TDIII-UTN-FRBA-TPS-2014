...
at task_struct.RSP0,          dq pila_TaskMalloc_L0+STACK_SIZE
at task_struct.RIP,           dq Tarea_Malloc
at task_struct.RDI,           dq 24
at task_struct.RSP,           dq pila_TaskMalloc_L3+STACK_SIZE
...
at dispatcher_task_struct.state,		dw TASK_READY	
...
ALIGN 16
pila_TaskC_L0: times 100h db 0
ALIGN 16
pila_TaskD_L0: times 100h db 0
ALIGN 16
pila_TaskE_L0: times 100h db 0
