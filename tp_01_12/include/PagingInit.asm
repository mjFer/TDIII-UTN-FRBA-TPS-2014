...
Task_A_PagingInit:
  ...
  mov dword [PT_BASE_TA + 0x58 ],0xB000 + 0x17;0x07	;a la zona de memoria de la tarea le doy RPL user
  mov dword [PT_BASE_TA + 0x5C], 0	  
...
Task_B_PagingInit:
  ...
  ;pagina de usuario para la tarea
  mov dword [PT_BASE_TB + 0x60 ],0xC000 + 0x17;0x07	;a la zona de memoria de la tarea le doy RPL user
